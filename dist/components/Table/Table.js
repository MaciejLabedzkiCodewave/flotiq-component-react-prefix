...
var Table = function Table(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement("table", _extends({
    className: ['fq-base fq-w-full fq-border-collapse fq-mt-2 fq-mb-4 fq-border fq-border-light'].concat(_toConsumableArray(additionalClasses)).join(' ')
    ...
    return /*#__PURE__*/_react.default.createElement("th", {
      className: "fq-border fq-border-light fq-p-3",
      key: column
    }, column);
